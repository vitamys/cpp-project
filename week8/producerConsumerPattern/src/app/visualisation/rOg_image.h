...
public slots:
    ...
    /*!
     * \save Image              This function saves the image in the view while keeping aspect ratio
     */
    void                    saveImage();
...
protected:
    ...
    /*!
     * \brief mouseDoubleClickEvent       Overload this function to process the window resizing event
